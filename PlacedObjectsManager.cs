...
//copied from henperepo and moved to a unique namespace
namespace ShortcutColorDevtoolObject
{
    public static class PlacedObjectsManager
    {
        ...
        public static ManualLogSource plog;
        /// <summary>
        ...
        private static void Apply()
        {
            if (_hooked) return;
            _hooked = true;
			//plog.LogWarning("Applying hooks");
        ...
        {
			plog.LogWarning("Making a custom objrep");
			orig(self, tp, pObj);
...
#pragma warning restore IDE0051 // Remove unused private members
        ...
        private static PlacedObject.Type DeclareOrGetEnum(string name)
        {
            ...
            catch
            {
                ...
                tp = (PlacedObject.Type)Enum.Parse(typeof(PlacedObject.Type), name);
				plog.LogInfo($"EE: {name}");
				//foreach (var nm in Enum.GetNames(typeof(PlacedObject.Type))) plog.LogWarning(nm);
            }
